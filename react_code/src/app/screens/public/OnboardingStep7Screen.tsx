...
import { ArrowRight, Sparkles, Building2, Gift } from 'lucide-react';
...
export default function OnboardingStep7Screen() {
  ...
  return (
    <div className="h-screen w-full relative overflow-hidden flex flex-col">
      {/* Back Button */}
      <BackButton to="/onboarding-step6" />
      ...
      <div className="relative z-10 h-full flex flex-col px-6 py-6 max-w-md mx-auto w-full">
        ...
        >
          ...
          <p className="text-gray-800 text-base font-medium drop-shadow-sm">Be part of meaningful moments</p>
        </motion.div>
        ...
        <div className="flex items-center justify-center" style={{ minHeight: '48vh' }}>
          ...
          >
            ...
            <div className="relative z-10 px-8 py-10 space-y-6">
              ...
              >
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-purple-400 via-pink-400 to-rose-400 shadow-xl shadow-pink-300/40">
              ...
              {/* Main Content */}
              <motion.p
                className="text-center text-xl text-gray-900 leading-relaxed font-medium"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.5 }}
              >
                Business offering gifts and services that help people express love?
              </motion.p>
              ...
              {/* CTA Message */}
              <motion.p
                className="text-center text-lg text-gray-900 leading-relaxed font-medium"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.7 }}
              >
                Register with CherishAI so your products can be suggested when they're needed most.
              </motion.p>
              ...
              >
                <div className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full border border-purple-200/50 shadow-md">
                  <Building2 className="w-4 h-4 text-purple-700" strokeWidth={2} />
                  <span className="text-base text-purple-800 font-semibold">Partner with us</span>
                </div>
              </motion.div>
            </div>
